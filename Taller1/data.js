...
for (let i = 0; i < arraySeries.length; i++) 
{
    ...
    //document.getElementById("id"+i.toString()).innerHTML = arraySeries[i].getId();
    ...
    //console.log(arraySeries[i].getName());
} 
...
function applyFilterByName(description, img, url) { 
    ...
    //alert (arraySeries[serieId].getName())
